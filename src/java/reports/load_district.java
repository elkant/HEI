    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for(String ct:county_array){
             if(!ct.equals("")){
                 where+=" county_id="+ct+" OR ";
             } 
            }
            
            where = removeLast(where, 3);
            output = "";
            query = "SELECT district_id,district_name FROM district WHERE ("+where+") ORDER BY district_name";
            ...
            System.out.println("county length : "+county_array.length+" and where clause : "+where);
